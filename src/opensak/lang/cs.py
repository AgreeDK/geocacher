...
STRINGS: dict[str, str] = {
    ...
    "update_loc_info":              "Údaje o poloze jsou načítány z OpenStreetMap (Nominatim) — stejný zdroj jako project-gc.\n\nZpracování je omezeno na jeden požadavek za sekundu. U velkých databází to může trvat několik minut.",
    "update_loc_progress":          "Aktualizuji {current} / {total}…",
    ...
    "update_loc_phase":             "Fáze {phase} z {total}…",
    "update_loc_phase1_label":      "⚡  Rychlé vyhledávání (offline)…",
    "update_loc_phase2_label":      "🔍  Zpřesnění okresu přes Nominatim…",
    "update_loc_row":               "{gc_code}: {country} / {state} / {county}",
    "update_loc_county_refined":    "{gc_code}: okres zpřesněn → {county}",
