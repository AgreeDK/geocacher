...
STRINGS: dict[str, str] = {
    ...
    "attr_wading":             "Pode exigir vau (atravessar água)",
    ...
    "attr_stealth":            "Necessária discrição (stealth)",
    "attr_needs_maintenance":  "Necessita de manutenção",
    "attr_dangerous_animals":  "Gado / animais perigosos",
    "attr_field_puzzle":       "Enigma de campo (field puzzle)",
    "attr_nightcache":         "Cache noturna",
    "attr_park_and_grab":      "Parar e apanhar (park and grab)",
