...
STRINGS: dict[str, str] = {
    ...
    "attr_atv":                     "Quads",
    "attr_jeeps":                   "Véhicules tout-terrain",
    "attr_snowmobile":              "Motoneiges",
    "attr_horses":                  "Chevaux",
    "attr_campfires":               "Feux de camp",
    "attr_trucks":                  "Camions/camping-cars",
    # Conditions
    "attr_kids":                    "Convient aux enfants",
    "attr_onehour":                 "Prend moins d\'une heure",
    "attr_scenic":                  "Vue panoramique",
    "attr_hiking":                  "Randonnée conséquente",
    "attr_climbing":                "Escalade difficile",
    "attr_wading":                  "Peut exiger de patauger",
    "attr_swimming":                "Peut exiger de nager",
    "attr_available":               "Accessible 24/7",
    "attr_night":                   "Recommandée de nuit",
    "attr_winter":                  "Accessible en hiver",
    "attr_stealth":                 "Discrétion oblige",
    "attr_needs_maintenance":       "Attention du propriétaire demandée",
    "attr_cow":                     "Bétail à proximité",
    "attr_field_puzzle":            "Énigme de terrain",
    "attr_nightcache":              "Cache de nuit",
    "attr_park_and_grab":           "Drive-in",
    "attr_abandoned_structure":     "Structure abandonnée",
    "attr_short_hike":              "Courte randonnée (<1 km)",
    "attr_medium_hike":             "Moyenne randonnée (1 km-10 km)",
    "attr_long_hike":               "Longue randonnée (>10 km)",
    "attr_seasonal":                "Accès saisonnier",
    "attr_tourist":                 "Recommandé pour les touristes",
    "attr_private":                 "Jardin (Propriété privée)",
    "attr_teamwork":                "Cache collaborative",
    "attr_challenge":               "Cache Challenge",
    "attr_power_trail":             "Power Trail",
    "attr_bonus":                   "Cache Bonus",
    # Spéciaux
    "attr_lost_found_tour":         "Lost and Found tour",
    "attr_partnership":             "Cache coopérative",
    "attr_geotour":                 "GéoTour",
    "attr_solution_checker":        "Checker Geocaching.com",
    # Équipement
    "attr_fee":                     "Frais d\'accès / stationnement",
    "attr_rappelling":              "Équipement d\'escalade nécessaire",
    "attr_boat":                    "Bateau nécessaire",
    "attr_scuba":                   "Equipement de plongée nécessaire",
    "attr_flashlight":              "Lampe torche nécessaire",
    "attr_uv":                      "Lampe UV nécessaire",
    "attr_snowshoes":               "Peut nécessiter des raquettes de randonnée",
    "attr_ski":                     "Peut nécessiter des skis de fond",
    "attr_special_tool":            "Outil particulier nécessaire",
    "attr_wirelessbeacon":          "Balise sans fil",
    "attr_tree_climbing":           "Escalade d\'arbre nécessaire",
    # Dangers
    "attr_poisonous_plants":        "Plantes vénéneuses",
    "attr_dangerous_animals":       "Animaux dangereux",
    "attr_ticks":                   "Tiques",
    "attr_mine":                    "Mine abandonnée",
    "attr_cliff":                   "Falaises/chute de pierres",
    "attr_hunting":                 "Zone de chasse",
    "attr_dangerous_area":          "Zone dangereuse",
    "attr_thorns":                  "Épines",
    # Installations
    "attr_wheelchair":              "Accessible en fauteuil roulant",
    "attr_parking":                 "Stationnement à proximité",
    "attr_public_transport":        "Transports en commun à proximité",
    "attr_water":                   "Eau potable à proximité",
    "attr_restrooms":               "Toilettes publiques à proximité",
    "attr_telephone":               "Cabine téléphonique à proximité",
    "attr_picnic":                  "Aire de pique-nique à proximité",
    "attr_camping":                 "Camping à proximité",
    "attr_stroller":                "Accessible aux poussettes",
    "attr_fuel":                    "Station service à proximité",
    "attr_food":                    "Restaurant à proximité",
